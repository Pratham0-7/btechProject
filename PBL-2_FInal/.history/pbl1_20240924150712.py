...
class YourSumoEnv(MultiAgentEnv):
    def __init__(self, env_config=None):
        ...
        self.sumo_binary = "D:\\sumo\\bin\\sumo-gui"  # Update to your SUMO installation path
    ...
    def reset(self):
        ...
        try:
            ...
            time.sleep(1)  # Wait for SUMO to start properly
            ...
            print(f"Error starting SUMO or TraCI: {e}")
