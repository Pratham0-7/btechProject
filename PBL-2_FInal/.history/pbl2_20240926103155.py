...
# Register the SUMO gym environment
register(
    id='sumo_gym:sumo-v0',  # Adjust the id based on naming conventions
    entry_point='sumo_gym.envs:SumoEnv',  # Replace with the actual class name in sumo_gym
)
