...
# Define the custom SUMO environment
class YourSumoEnv(MultiAgentEnv):
    def __init__(self, env_config=None):
        ...
        self.sumo_route_file = "D:\PBL-2_FInal\generated_routes.rou.xml"  # Path to your SUMO route file
...
# Custom callback class without extending DefaultCallbacks
...
def add_multi_agent_policy():
    config.multi_agent(
        ...
        policy_mapping_fn=lambda agent_id: "default_policy"  # Map agents to the policy
    )
