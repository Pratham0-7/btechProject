...
def generate_routes(net_file, route_file):
    command = ["duarouter", "--net-file", net_file, "--output", route_file]
    subprocess.run(command, check=True)  # Check for errors during execution
...
if __name__ == "__main__":
    ...
    output_route_file = "D:/PBL-2_FInal/routes.xml"
    
    # Generate the routes file
    generate_routes(input_net_file, output_route_file)
    
    sumo_cfg_file = "D:/PBL-2_FInal/map.sumocfg"
    net_file = input_net_file  # Use the original net file
