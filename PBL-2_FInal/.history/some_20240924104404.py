...
sumo_tools_path = r"C:\Path\to\sumo\tools"  # Update this with your SUMO tools path
sumo_bin = r"C:\Path\to\sumo\bin\sumo"  # Update with SUMO bin path
net_file = r"D:\path\to\your\map.net.xml"  # Path to your map.net.xml
route_file = r"D:\path\to\your\route.rou.xml"  # Output route file
