...
class CustomSUMOEnv(FMPEnv):  # Inherit from FMPEnv
    def __init__(self, mode='your_mode_here'):  # Add mode parameter
        super(CustomSUMOEnv, self).__init__(config_file='map.sumocfg', mode=mode)  # Pass mode to FMPEnv
...
if __name__ == "__main__":
    env = CustomSUMOEnv(mode='your_mode_here')  # Specify the mode here
