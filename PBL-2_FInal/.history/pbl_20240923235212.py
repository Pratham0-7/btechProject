...
class CustomSUMOEnv(FMPEnv):
    def __init__(self, mode='train'):  # Specify the mode you want to use
        super(CustomSUMOEnv, self).__init__(mode=mode, config_file='map.sumocfg')  # Update with your SUMO config file
...
if __name__ == "__main__":
    env = CustomSUMOEnv(mode='train')  # Specify the mode for training
