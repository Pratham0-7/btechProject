...
def generate_routes(net_file, route_file, num_vehicles):
    # Modify this command according to the correct options for your version of SUMO
    command = ["duarouter", "--net-file", net_file, "--route-files", route_file]
    
    # If 'num_vehicles' is a valid argument for your version, add it here
    if num_vehicles > 0:  # Check if num_vehicles is valid
        command.append("--number")
        command.append(str(num_vehicles))
